...
class WichuonCharoensombat:
    def __init__(self):
        self.name = "Wichuon Charoensombat"
        self.role = "Digital Engineering Student"
        self.minor = "Data Science"
        self.interests = ["Machine Learning", "Web Development", "Mobile Apps"]
        self.currently_learning = ["PyTorch", "TensorFlow", "NestJS"]
        
    def say_hi(self):
        print("Thanks for dropping by! Let's build something amazing together!")

me = WichuonCharoensombat()
me.say_hi()
```
...
<div align="center">
  ...
  <a href="mailto:wichuon.cha@gmail.com" target="_blank">
...
<p align="center">
  <i>"Innovation distinguishes between a leader and a follower."</i><br/>
...
<p align="center">
  ⭐️ From <a href="https://github.com/PinturaW">PinturaW</a> with ❤️
</p>
